...
const C = {
  ...
  card:     '#12163d',
  cardHover:'#161a48',
  border:   'rgba(139, 34, 82, 0.25)',
  gold:     '#c9a84c',
  rose:     '#8b2252',
  roseLight:'#b83070',
  text:     '#e8e0d0',
  textMid:  'rgba(232,224,208,0.7)',
  textDim:  'rgba(232,224,208,0.45)',
  white:    '#ffffff',
  good:     '#4a7a5a',
  goodBg:   'rgba(74,122,90,0.15)',
  bad:      '#7a3a2a',
  badBg:    'rgba(122,58,42,0.15)',
  mixed:    '#7a6a2a',
  mixedBg:  'rgba(122,106,42,0.15)',
  neutral:  '#4a5a7a',
  neutralBg:'rgba(74,90,122,0.15)',
};
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Vedic science of moles (Samudrika Shastra). Decode the meaning of moles by color, shape, and body location according to classical Til Vichar traditions."
        />
