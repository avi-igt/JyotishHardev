      ...
      <main className="page">
        ...
        <div className="container">
          ...
          <div className="hero">
            ...
            <div className="social-row" style={{ marginTop: 16, marginBottom: 0 }}>
              <span className="social-label">Share</span>
              <button className="social-btn" style={{ '--brand': '#25D366' } as any} onClick={() => { const u = 'https://jyotishhardev.com'; const t = 'Free Vedic Kundli generator — no login, instant chart. Try it:'; window.open(`https://wa.me/?text=${encodeURIComponent(t + ' ' + u)}`, '_blank'); }} title="WhatsApp" aria-label="Share on WhatsApp">
              ...
              <button className="social-btn" style={{ '--brand': '#000000' } as any} onClick={() => { const u = 'https://jyotishhardev.com'; const t = 'Free Vedic Kundli generator — no login, instant chart.'; window.open(`https://twitter.com/intent/tweet?text=${encodeURIComponent(t)}&url=${encodeURIComponent(u)}`, '_blank'); }} title="X (Twitter)" aria-label="Share on X">
              ...
              <button className="social-btn" style={{ '--brand': '#1877F2' } as any} onClick={() => { window.open(`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent('https://jyotishhardev.com')}`, '_blank'); }} title="Facebook" aria-label="Share on Facebook">
                <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </button>
              <button className="social-btn" style={{ '--brand': '#2AABEE' } as any} onClick={() => { const u = 'https://jyotishhardev.com'; const t = 'Free Vedic Kundli generator — no login, instant chart.'; window.open(`https://t.me/share/url?url=${encodeURIComponent(u)}&text=${encodeURIComponent(t)}`, '_blank'); }} title="Telegram" aria-label="Share on Telegram">
